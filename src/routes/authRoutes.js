...
router.post("/api/resendEmail", async (req, res) => {
  try {
    ...
    const msg = {
      ...
      text:
        `Dear Friend\n\n` +
        `Please click the confirmation link or paste it in the browser ${process.env.SERVER_ORIGIN}/confirm?id=${userId} to activate your account and login.\n` +
        `From now on please login to your account using your email address and password.\n` +
        `Thank you\n` +
        `This is an autogenerated mail, please do not reply.\n\n`,
    };
